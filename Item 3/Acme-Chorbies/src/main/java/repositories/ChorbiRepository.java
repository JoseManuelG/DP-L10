...
public interface ChorbiRepository extends JpaRepository<Chorbi, Integer> {
	...
	Collection<Chorbi> searchChorbisWithOutGenre(String desiredRelathionship, String keyword, String cityCoordinate, String provinceCoordinate, String countryCoordinate, String stateCoordinate, Date firstDate, Date SecondDate);
	...
	Collection<Chorbi> searchChorbisWithoutAgeAndGenre(String desiredRelathionship, String keyword, String cityCoordinate, String provinceCoordinate, String countryCoordinate, String stateCoordinate);
